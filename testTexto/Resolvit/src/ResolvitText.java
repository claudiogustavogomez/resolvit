...
public class ResolvitText {
	...
	public static void main(String[] args) {
        ...
        countMatchesByLine(wordCount1, wordCount2, wordCount3, wordCount4, wordCount5, wordCount6, hashByLine);
	}
	...
	private static void countMatchesByWord(List<String> lista) {
		int cont;
	...
	private static void countMatchesByLine(List<String> lista1, List<String> lista2, List<String> lista3, List<String> lista4, List<String> lista5, List<String> lista6, HashSet<String> hashByLine) {
